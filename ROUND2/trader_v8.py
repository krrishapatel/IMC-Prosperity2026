...
#
# Round 2 MAF: bid() below. Top 50% pay bid and get +25% quotes. Manual invest PnL:
# (Research × Scale × Speed) − budget_used — see competition wiki.
...
class Trader:
    ...
    def bid(self) -> int:
        """Round 2 only. XIRECs paid if bid is in top 50% (extra order-book depth)."""
        return MAF_BID
